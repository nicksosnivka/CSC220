...
public class Library {
  ...
  public ArrayList<LibraryBook> lookup(String holder) {
	  ...
	  ArrayList<LibraryBook> holdLibrary = new ArrayList<LibraryBook>();
	  
	  for (int i = 0; i < library.size(); i++) {
		  if (holder.equals(library.get(i).getHolder())) {
			  holdLibrary.add(library.get(i));
		  }
	  }
	  
	  //library.get(i).getHolder().equals(holder)
	  return holdLibrary;
  }  
  ...
  public boolean checkin(String holder) {
	  ...
	  ArrayList<LibraryBook> tempLibrary = new ArrayList<LibraryBook>();
